...
var apiKeyGPTModelPrices = map[string]apiKeyModelPrice{
	...
	"gpt-5.3-codex-spark":        {input: 0.01, cachedInput: 0, output: 0.01},
	"gpt-5.3-codex-spark-low":    {input: 0.01, cachedInput: 0, output: 0.01},
	"gpt-5.3-codex-spark-medium": {input: 0.01, cachedInput: 0, output: 0.01},
	"gpt-5.3-codex-spark-high":   {input: 0.01, cachedInput: 0, output: 0.01},
	"gpt-5.3-codex-spark-xhigh":  {input: 0.01, cachedInput: 0, output: 0.01},
